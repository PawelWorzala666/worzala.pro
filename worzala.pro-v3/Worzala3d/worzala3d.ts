...
import {WebGLRenderingContext, WebGLShader, WebGLProgram, WebGLBuffer, GLint} from './WebGL/WebGL';
...
const FRAGMENT_SHADER_CODE: string = /*glsl*/ `#version 300 es
  ...
  void main() {
    color = vec4( 0.00001, 0.000001, 0.000001, 1.0 );
  }
`;

// initialize webgl
var gl = new WebGLRenderingContext('rngette', 'webgl2');
...
export function displayLoop(): void {
  //             R    G    B    A
  gl.clearColor(0.000000, 0.000000, 0.00000000, 1.0);
